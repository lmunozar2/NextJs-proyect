...
export default async function GamesInfo({ searchParams }: GamesInfoProps) {
  ...
  // ✅ Agrega consoles al Promise.all
            ...
            >
              ...
              <div
                className={`absolute top-3 right-3 flex gap-2 transition-opacity duration-300 
                    ${activeCard === game.id ? "opacity-100" : "opacity-0 md:group-hover:opacity-100"}`}
              >
              ...
              <div
                className={`absolute bottom-0 left-0 right-0 p-4 transition-transform duration-500 
                        ${activeCard === game.id ? "-translate-y-32" : "md:group-hover:-translate-y-32"}`}
              >
              ...
              <div
                className={`absolute bottom-0 left-0 right-0 p-4 transition-transform duration-500 
                        ${activeCard === game.id ? "translate-y-0" : "translate-y-full md:group-hover:translate-y-0"}`}>
